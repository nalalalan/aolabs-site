...
\begin{itemize}
  \item \href{https://sarrus.aolabs.io}{Sarrus}: programmable soft-robotic cells for shape change, stiffness control, object manipulation, and locomotion; \href{https://sarrus.aolabs.io/mechanism.html}{mechanism record}: geometry, actuation, build state, and force/stiffness characterization.
