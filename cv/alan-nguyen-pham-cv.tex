...
\begin{itemize}
  \item Developing soft robotic morphing surfaces that turn flat printed cell arrays into overhangs, waves, and domes.
  \item Designed printed Sarrus/PneuNet cells with cross-cell air channels, bending bias, and snap-fit connectors.
  \item Demonstrated planar arrays, cylinders, object transport/capture, peristaltic crawling, and rolling locomotion.
  \item Created Wavevis to map target surfaces to lattice topology, cell displacement, connector limits, and prototype dimensions.
  \item Developing FluxCell for shared pressure routing, snap-fit air connections, and local on/off PneuNet flow control.
\end{itemize}
