...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate developing inverse computational mechanism design for soft robotic morphing surfaces that become dynamic 3D forms, including wave-like motion and complex morphing behavior. Targeting mechanical R\&D roles in morphing systems, compliant mechanisms, inverse design, and simulation-guided physical prototyping.}}
...
\begin{itemize}
  ...
  \item Reassembled the same cell family into planar and cylindrical mechanism layouts for continuum bending/grasping, 200~mm peristaltic crawling, and self-rolling locomotion.
  \item Created Wavevis through iterative AI-assisted development, specifying target-shape behavior, evaluating generated geometry/UI states, and refining a public computational-design environment for lattice geometry, connector constraints, opposite-pair motion constraints, and variable pair-angle shape studies.
  \item Validating simulation-derived linkage geometry, connector constraints, and kinematic shape generation through rapid physical prototype iteration for scalable pneumatic morphing-surface systems.
  \item Developing FluxCell, a scalable pneumatic-mechanical cell architecture for single-inlet pressure distribution through self-sealing snap-fit inter-cell connections and magnet/electropermanent-magnet control of individual PneuNet airflow.
\end{itemize}
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \textit{FluxCell pneumatic-mechanical robotic-cell system} [Research platform for self-sealing snap-fit single-inlet pressure distribution, simulation-guided linkage and connector design, and magnet/electropermanent-magnet PneuNet flow control].
