...
{\fontsize{22}{25}\selectfont\textbf{Alan Nguyen Pham}}\hfill{\large\textbf{\textcolor{accent}{Mechanical R\&D \textbar{} Soft Robotics \textbar{} Physical Interaction}}}\\[-1pt]
...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate building soft robotic materials, reconfigurable mechanisms, mechanical-memory cells, and mechanism simulators for human-facing physical systems. Targeting mechanical R\&D roles where CAD/fabrication, experimental characterization, pneumatic/compliant mechanisms, and visible physical behavior meet.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotics; morphing mechanisms; robotic materials; compliant mechanisms; pneumatic actuation; electropermanent magnetic latching; mechanism simulation; inverse-sheet design; mechanical design; CAD/fabrication; force/stiffness testing; motion systems; haptics; human-robot interaction; physical HCI; experimental mechanics; nonlinear dynamics; shape displays; adaptive interfaces.}
...
\begin{itemize}
  \item Led first-author research on reconfigurable Sarrus-linkage soft-robotic cells that turn one monolithically printed pneumatic Sarrus/PneuNet unit into planar, cylindrical, and locomotion assemblies.
  ...
  \item Built Wavevis, a public React/TypeScript/Three.js mechanism visualizer for double-layer Sarrus-cell arrays and inverse overhang sheets, with geometry-invariant checks and CSV/JSON export for deformation metrics.
  \item Used Wavevis to reject an all-four-equal X-cell overhang branch and select pairwise opposite-equal X-cells under shared connector-contact constraints, documenting the decision in a June 2026 constraint proof.
  \item Developed FluxCell as a bounded electropermanent-magnetic Sarrus-cell mechanical-memory proof, reducing the next experiment to one-axis keeper overlap, a purchase-ready parts list, and pending stroke/current/hold/release/thermal evidence gates.
...
\begin{itemize}
  \item Pham, A. N., Rao, P., \& Onal, C. D. (2026). Manuscript in prep.: \textit{Reconfigurable Sarrus-linkage cells for multifunctional soft robots}.
  \item Pham, A. N. (2026). \href{https://aolabs.io/wavevis/proofs/connector-contact-constraint-proof.pdf}{\textit{Wavevis overhang connector assignment: evidence rejecting all-four-equal X-cells}} [Constraint proof and public simulator note].
  \item Pham, A. N. (2026). \textit{Pulse-programmed mechanical memory in an electropermanent robotic cell} [FluxCell design manuscript and evidence protocol; measured actuation data pending].
...
Software & CUBIT, Sierra/SolidMechanics, ParaView, MATLAB, Simulink Simscape Multibody, Abaqus, Ansys FEA, Python, C/C++, TypeScript, React, Three.js, ROS2, LabVIEW, Minitab, MS Office.\\
