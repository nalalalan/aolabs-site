...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate developing inverse computational mechanism design for soft robotic surfaces that form waves, overhangs, domes, and other 3D geometries. Work spans Sarrus/PneuNet cell assemblies, lattice-topology selection, pneumatic routing, and simulation-guided physical prototyping.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotics; morphing surfaces; modular pneumatics; inverse computational mechanism design; wave/overhang geometry; compliant mechanisms; linkage kinematics; airflow routing; constraint-based design.}
...
\begin{itemize}
  \item Built monolithically printed Sarrus/PneuNet cell assemblies that form single/double domes, bilayer overhangs, traveling waves, and object-transport surfaces.
  ...
  \item Created Wavevis, an AI-assisted computational-design environment for target shapes, lattice topologies, connector constraints, equal/collinear opposite-pair displacement, variable pair angles, and output metrics for mechanism selection and CAD decisions.
  \item Validating simulated linkage geometry with physical prototypes for connector clearance, leg displacement, topology configuration, cell-array kinematics, and pneumatic morphing-cell integration.
  \item Developing FluxCell, a pneumatic-mechanical cell architecture for shared inlet pressure, self-sealing snap-fit inter-cell air connections, and magnet/electropermanent-magnet valve concepts for individual PneuNet airflow.
\end{itemize}
...
\begin{itemize}
  ...
  \item Refined the ``Spirobs'' arm by pairing triple-cable actuation with an elastic braided-steel backbone for multidirectional bending, mechanical compliance, dust-resistant operation, and reduced maintenance.
  \item Led CAD updates, 3D-printing decisions, assembly strategy, and structured test/evaluation planning while guiding undergraduate teammates and coordinating with NASA subject matter experts.
\end{itemize}
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \href{https://aolabs.io/wavevis/}{\textit{Wavevis: inverse computational design environment for modular robotic surface mechanisms}} [AI-assisted tool for target shapes, lattice topology, connector constraints, and linkage design].
  \item Pham, A. N. (2026). \textit{FluxCell pneumatic-mechanical robotic-cell system} [Robotic-cell work on shared-pressure pneumatic routing, self-sealing snap-fit air connections, linkage/connector design, and magnet/electropermanent-magnet PneuNet flow control].
