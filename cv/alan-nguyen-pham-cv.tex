...
\begin{itemize}
  ...
  \item \href{https://sarrus.aolabs.io/mechanism.html}{Sarrus mechanism page}: mechanical record covering geometry, constraint path, actuation, force/stiffness characterization, build state, and motion examples.
