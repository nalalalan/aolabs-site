...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate building computationally designed soft robotic mechanisms for tabletop morphing surfaces that form wave-like 3D geometry and overhangs. Targeting mechanical R\&D roles in computational design, compliant mechanisms, inverse design, and simulation-guided physical prototyping.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotics; morphing surfaces; tabletop wave-forming mechanisms; overhang-capable compliant systems; computational design; simulation-guided inverse design; complex 3D surface motion; adaptive interfaces.}
...
\begin{itemize}
  \item Built a tabletop soft-robotic morphing-surface platform that produces single/double domes, bilayer overhangs, traveling waves, and object transport from modular pneumatic cell assemblies.
...
Soft robotics & Pneumatic actuation, compliant mechanisms, continuum robots, modular soft robots, morphing surfaces, overhang-capable surface prototypes, simulation-guided robotic prototyping.\\
