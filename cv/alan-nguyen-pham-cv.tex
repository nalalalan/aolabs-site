...
{\fontsize{22}{25}\selectfont\textbf{Alan Nguyen Pham}}\hfill{\large\textbf{\textcolor{accent}{Mechanical R\&D \textbar{} Soft Robotics \textbar{} Computational Design}}}\\[-1pt]
...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate developing inverse computational mechanism design for soft robotic morphing surfaces that become dynamic 3D forms, including wave-like motion and complex morphing behavior. Targeting mechanical R\&D roles in computational design, compliant mechanisms, inverse design, and simulation-guided physical prototyping.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotics; morphing surfaces; inverse computational mechanism design; dynamic 3D surface transformation; wave-like physical systems; compliant mechanisms; constraint-based design; adaptive interfaces.}
...
\begin{itemize}
  \item Built a soft-robotic morphing-surface platform that produces dynamic 3D forms including single/double domes, bilayer overhangs, traveling waves, and object transport from modular pneumatic cell assemblies.
  \item Explored planar-to-cylindrical reassembly as one mechanism family, including continuum bending/grasping, 200~mm peristaltic crawling, and self-rolling locomotion.
  \item Mapped pressure-dependent deformation, hysteresis, and variable stiffness to link actuator geometry and sequencing to macroscopic 3D surface motion.
  \item Created Wavevis through iterative AI-assisted development, specifying target-shape behavior, evaluating generated geometry/UI states, and refining a public computational-design environment for lattice/connector constraints and mechanism-family feasibility checks.
...
\begin{itemize}
  ...
  \item Developed broader-impact framing for robotics and AI systems that operate near people, emphasizing workplace adoption, trust, training, and responsible deployment.
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \href{https://aolabs.io/wavevis/}{\textit{Wavevis: inverse computational design environment for modular robotic surface mechanisms}} [Public AI-assisted target-shape, constraint-analysis, and mechanism-design tool].
...
Soft robotics & Pneumatic actuation, compliant mechanisms, continuum robots, modular soft robots, morphing surfaces, dynamic surface prototypes, simulation-guided robotic prototyping.\\
Software & CUBIT, Sierra/SolidMechanics, ParaView, MATLAB, Simulink Simscape Multibody, Abaqus, Ansys FEA, Python, C/C++, ROS2, LabVIEW, Minitab, MS Office; AI-assisted computational-design and web-tool prototyping.\\
