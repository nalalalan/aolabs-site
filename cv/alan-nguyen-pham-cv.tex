...
\begin{itemize}
  ...
  \item Built Wavevis, a public React/TypeScript/Three.js computational-design environment that translates target surface deformations into lattice/connector constraints, mechanism-family feasibility checks, and mechanism geometry/design metrics.
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \href{https://aolabs.io/wavevis/}{\textit{Wavevis: inverse computational design environment for modular robotic surface mechanisms}} [Public target-shape, constraint-analysis, and mechanism-design tool].
