...
\textcolor{muted}{Soft robotics; morphing mechanisms; robotic materials; compliant mechanisms; pneumatic actuation; mechanical design; CAD/fabrication; force/stiffness testing; motion systems; haptics; human-robot interaction; physical HCI; experimental mechanics; nonlinear dynamics; shape displays; adaptive interfaces.}
...
\begin{itemize}
  \item \href{https://aolabs.io/sandia/}{Sandia NOMAD}: ratcheting-mechanism sensitivity study, coauthored paper, final presentation, and internship research record.
  \item \href{https://sarrus.aolabs.io}{Sarrus}: programmable soft-robotic cells for shape change, stiffness control, object manipulation, locomotion, and visible motion behavior.
...
\begin{itemize}
  ...
  \item Winston, S., Pham, A., Bahr, B., Singh, A., Schumann, C., Flicek, R., Grutzik, S., Kuether, R. J., \& Vemaganti, K. (2025). \href{https://aolabs.io/sandia/paper.pdf}{\textit{Quantifying the Effect of Non-Physical Parameters on the Nonlinear Dynamics of an Electromechanical Ratcheting Mechanism}}. Sandia National Laboratories NOMAD research paper.
