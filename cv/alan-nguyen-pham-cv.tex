...
\begin{itemize}
  \item Developing soft robotic morphing surfaces that transform flat sheets into 3D forms with overhangs and wave-like profiles.
  \item Built monolithically printed Sarrus/PneuNet-inspired cell assemblies for surface-scale morphing, with demonstrations across planar surfaces, cylindrical structures, object transport, peristaltic crawling, and rolling locomotion.
  \item Created Wavevis, a computational design tool for translating target surface shapes into lattice topology, displacement constraints, connector behavior, and buildability tradeoffs.
  \item Developing FluxCell, a modular pneumatic-mechanical surface architecture with shared pressure routing, snap-fit air connections, and local flow-control concepts.
  \item Iterating CAD, printed prototypes, pneumatic tests, and mechanism constraints toward the core milestone: a flat morphing surface forming a self-supporting overhang.
\end{itemize}
