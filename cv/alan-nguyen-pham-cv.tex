...
\begin{itemize}
  \item Developing soft robotic morphing surfaces that turn flat cell arrays into overhangs, waves, and domes.
  \item Built Sarrus/PneuNet-inspired cells with cross-cell air channels, bending bias, and snap-fit connectors.
  \item Demonstrated planar arrays, cylinders, object transport/capture, peristaltic crawling, and rolling locomotion.
  \item Created Wavevis to map target surface shapes into lattice topology, cell displacement, and connector geometry.
  \item Developing FluxCell around one shared air inlet, self-sealing snap-fit cell connections, and magnet/EPM valves that route air into printed PneuNets.
\end{itemize}
