...
\begin{itemize}
  \item Created a monolithically printed Sarrus/PneuNet soft-robotic architecture that reconfigures from planar morphing sheets into cylindrical continuum robots and crawling/rolling locomotion assemblies.
  \item Demonstrated programmable behaviors: single- and double-dome shape displays, bilayer overhangs, tennis-ball transport/capture, continuum bending/grasping, 200~mm peristaltic crawling, self-rolling, and horizontal, diagonal, and circular traveling waves.
  \item Characterized pressure-dependent expansion, bending angle, force-displacement response, hysteresis, and variable stiffness to link geometry and actuation patterns to macroscopic behavior.
  ...
  \item Developing FluxCell, a 3D-printed pneumatic-mechanical robotic-cell system with inter-cell connectors that physically join neighboring cells, pass shared manifold pressure, and route air through magnet- or electropermanent-magnet valve concepts into individual PneuNets.
\end{itemize}
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \textit{FluxCell pneumatic-mechanical robotic-cell system} [Research platform for 3D-printed inter-cell connectors, shared manifold pressure, and magnet- or electropermanent-magnet valve concepts for PneuNet actuation].
