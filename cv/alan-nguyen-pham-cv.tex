...
\begin{itemize}
  ...
  \item Developing FluxCell, a pneumatic-mechanical robotic-cell system for programmable soft structures that integrates manifolded pneumatic actuation, magnetic latching/state control, and cell-level mechanical coupling.
\end{itemize}
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \textit{FluxCell pneumatic-mechanical robotic-cell system} [Research platform for programmable soft structures with manifolded pneumatic actuation, magnetic latching/state control, and cell-level mechanical coupling].
