...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate building computationally designed soft robotic mechanisms that turn physical surfaces into dynamic 3D forms, including wave-like motion and complex morphing behavior. Targeting mechanical R\&D roles in computational design, compliant mechanisms, inverse design, and simulation-guided physical prototyping.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotics; morphing surfaces; dynamic 3D surface transformation; wave-like physical systems; compliant mechanisms; computational design; simulation-guided inverse design; adaptive interfaces.}
...
\begin{itemize}
  ...
  \item Built Wavevis, a public React/TypeScript/Three.js computational-design tool for simulating 3D morphing mechanisms, inspecting inverse sheet deformation, and exporting geometry/metrics for mechanism design.
