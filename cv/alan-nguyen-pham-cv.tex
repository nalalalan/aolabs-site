...
{\large\textbf{\textcolor{accent}{Mechanical R\&D \textbar{} Morphing Robotic Surfaces \textbar{} Computational Design}}}\\[-1pt]
...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate developing soft robotic morphing surfaces that transform planar sheets into difficult 3D geometries, especially overhanging and wave-like forms. Work combines inverse simulation, constrained mechanism design, compliant cell architectures, pneumatic routing, and physical prototyping to translate target shapes into buildable robotic hardware.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotic morphing surfaces; inverse design for overhanging and wave-like geometries; compliant mechanism design; topology configuration; constrained linkage and cell architectures; pneumatic actuation and routing;\\[-1pt] snap-fit pneumatic-mechanical connections; simulation-guided physical prototyping.}
...
\begin{itemize}
  \item Developing a tabletop soft-robotic morphing surface for transforming an initially planar sheet into overhanging and wave-like 3D forms.
  \item Built monolithically printed Sarrus/PneuNet-inspired cell assemblies as one candidate mechanism for converting target surface motion into fabricated morphing hardware, with demonstrations spanning planar surfaces, cylindrical structures, object transport, peristaltic crawling, and rolling locomotion.
  \item Using inverse simulation to reason backward from target shapes to required local cell motions, edge stretch, node bending, connector constraints, and topology configurations before committing to a physical mechanism.
  \item Created and iterated Wavevis through AI-assisted prototyping as a design interface for exploring target shapes, lattice topology, displacement constraints, connector behavior, and buildability tradeoffs for morphing robotic surfaces.
  \item Developing FluxCell, a modular pneumatic-mechanical cell concept for shared-pressure routing, snap-fit inter-cell air connections, and local on/off flow-control concepts for printed PneuNet actuation.
\end{itemize}
