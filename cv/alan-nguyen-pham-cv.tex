...
\begin{itemize}
  ...
  \item Prototyping actuatorless printed linkage arrays with hand-configurable clip states to validate simulation-derived 3D surface behavior before pneumatic integration.
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \textit{FluxCell pneumatic-mechanical robotic-cell system} [Research platform for self-sealing snap-fit single-inlet pressure distribution, actuatorless linkage validation, and magnet/electropermanent-magnet PneuNet flow control].
