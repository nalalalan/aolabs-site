...
{\fontsize{22}{25}\selectfont\textbf{Alan Nguyen Pham}}\hfill{\large\textbf{\textcolor{accent}{Mechanical R\&D \textbar{} Physical Prototypes}}}\\[-1pt]
...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate building soft robotic materials, reconfigurable mechanisms, and morphing interfaces for adaptive, human-facing physical systems. Targeting mechanical R\&D roles where CAD/fabrication, experimental characterization, compliant mechanisms, and physical storytelling meet, with emphasis on systems that change shape, move through contact, and make complex mechanics tangible.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotics; morphing mechanisms; robotic materials; compliant mechanisms; pneumatic actuation; mechanical design; CAD/fabrication; force/stiffness testing; haptics; human-robot interaction; physical HCI; experimental mechanics; nonlinear dynamics; shape displays; adaptive interfaces.}
...
\begin{itemize}
  \item \href{https://sarrus.aolabs.io}{Sarrus}: public project page for programmable shape, stiffness, and motion from Sarrus-linkage soft-robotic cells.
  \item \href{https://sarrus.aolabs.io/mechanism.html}{Sarrus mechanism page}: reviewer-facing mechanical artifact covering geometry, constraint path, actuation, force/stiffness characterization, prototype state, and physical-experience translation.
  \item \href{https://aolabs.io}{AO Labs}: deployed portfolio of research projects, prototypes, tools, and public work connecting mechanical systems, physical interaction, and autonomous software.
\end{itemize}
