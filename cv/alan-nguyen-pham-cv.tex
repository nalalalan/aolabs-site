...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate building soft robotic materials, reconfigurable mechanisms, pneumatic-mechanical robotic cells, and mechanism simulators for human-facing physical systems. Targeting mechanical R\&D roles where CAD/fabrication, experimental characterization, pneumatic/compliant mechanisms, and visible physical behavior meet.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotics; morphing mechanisms; robotic materials; compliant mechanisms; pneumatic actuation; pneumatic-mechanical connections; electropermanent magnets; integrated manifolds; mechanism simulation; inverse-sheet design; mechanical design; CAD/fabrication; force/stiffness testing; motion systems; haptics; human-robot interaction; physical HCI; experimental mechanics; nonlinear dynamics; shape displays; adaptive interfaces.}
...
\begin{itemize}
  ...
  \item Built Wavevis, a public React/TypeScript/Three.js mechanism visualizer for programming double-layer Sarrus-cell arrays, inspecting inverse sheet deformation, and exporting geometry/metrics for mechanism design.
  \item Developed the current FluxCell plan around a pneumatic-mechanical connection using Presta valves and magnets, enabling one pneumatic inlet instead of individual cell lines and using an internal EPM pneumatic actuator to bridge the integrated manifold with individual cell actuation.
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \href{https://aolabs.io/wavevis/}{\textit{Wavevis: interactive 3D visualization for double-layer Sarrus-cell arrays and inverse sheet deformation}} [Public simulator and mechanism-design tool].
  \item Pham, A. N. (2026). \textit{FluxCell pneumatic-mechanical connection plan} [Design update: Presta-valve/magnet connection, one-inlet manifold architecture, and EPM internal pneumatic-actuator bridge].
