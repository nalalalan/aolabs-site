...
\profilebox{\textcolor{text}{Mechanical engineering Ph.D. candidate developing inverse computational mechanism design for soft robotic surfaces that form waves, overhangs, domes, and other 3D geometries. Targeting mechanical R\&D roles in soft robotics, compliant mechanisms, inverse design, and simulation-guided physical prototyping.}}

\section*{Research Focus}
\textcolor{muted}{Soft robotics; morphing surfaces; inverse computational mechanism design; wave-like motion; compliant mechanisms; linkage kinematics; constraint-based design.}
...
\begin{itemize}
  \item Built soft-robotic cell assemblies that form single/double domes, bilayer overhangs, traveling waves, and object-transport surfaces.
  \item Reconfigured the same cell family into planar and cylindrical topologies for continuum bending/grasping, peristaltic crawling, and self-rolling locomotion.
  \item Created Wavevis, an AI-assisted computational-design environment for target shapes, lattice topologies, connector constraints, equal/collinear opposite-pair displacement, and variable pair angles.
  \item Validating simulated linkage geometry, connector constraints, and cell-array kinematics with physical prototypes for pneumatic morphing cells.
  \item Developing FluxCell, a pneumatic-mechanical cell architecture for single-inlet pressure distribution through self-sealing snap-fit inter-cell connections and magnet/electropermanent-magnet control of individual PneuNet airflow.
\end{itemize}

\roleentry{NASA L' SPACE (NPWEE), Tempe, AZ}{Aug 2025 -- Present}{Soft Robotics Graduate Researcher -- Project SELENE}{}
\begin{itemize}
  \item Contributed to Project SELENE, a student exploration-robotics effort developing soft robotic hardware for remote and extreme environments.
...
\begin{itemize}
  ...
  \item Presented final results showing submodel-scale simulation sensitivity, informing setup choices before full assembly-level ratcheting models.
\end{itemize}
...
\begin{itemize}
  ...
  \item Pham, A. N. (2026). \href{https://aolabs.io/wavevis/}{\textit{Wavevis: inverse computational design environment for modular robotic surface mechanisms}} [AI-assisted tool for target shapes, lattice constraints, and linkage design].
  \item Pham, A. N. (2026). \textit{FluxCell pneumatic-mechanical robotic-cell system} [Robotic-cell work on self-sealing snap-fit pressure distribution, linkage/connector design, and magnet/electropermanent-magnet PneuNet flow control].
...
Soft robotics & Pneumatic actuation, compliant mechanisms, continuum robots, modular soft robots, morphing surfaces, pneumatic surface prototypes, simulation-guided robotic prototyping.\\
