...
\begin{itemize}
  \item Lead first-author research on a reconfigurable cellular soft-robotics architecture that turns one monolithically printed pneumatic Sarrus/PneuNet unit into multiple robotic topologies.
  ...
  \item Reconfigured the same module family into cylindrical soft robots for continuum bending, object grasping and placement, approximately 200 mm peristaltic crawling, and self-rolling locomotion.
...
\begin{itemize}
  \item Advance Project SELENE, a multidisciplinary exploration-robotics effort developing adaptable, resilient robotic systems for extreme and remote environments, including beyond-Earth mission concepts.
...
\begin{itemize}
  ...
  \item Connect doctoral research to haptic and virtual training, soft robotic teleoperation, compliant interaction, and human guidance of robots for high-skill physical tasks.
...
\begin{itemize}
  ...
  \item Applied FFT, spatial averaging, and harmonic analysis to compare string and bridge excitation responses, identifying how low-frequency support, modal balance, and structural differences affected perceived tone.
\end{itemize}
...
\begin{itemize}
  \item Develop learning activities for Stress Analysis, Statics, and Computer Aided Design with professors and teaching teams.
  \item Lead weekly conference sessions and office hours for 90+ student groups, translating difficult engineering material into interactive problem-solving sessions.
  \item Design hands-on learning sessions and guide students in connecting classroom mechanics concepts to physical models and engineering judgment.
\end{itemize}
...
\begin{itemize}
  \item Optimized components for thrust, line-shaft, stern-tube, and strut bearing assemblies using SolidWorks and Abaqus FEA, then proposed material and labor cost-reduction strategies.
